...
public class EmployeeResource {
   ...
   @Path("{id}")
   public Employee get(@PathParam("id") final int id) {
   ...
   public void addToList(@FormParam("name") final String name,
   ...
   @PUT
   public void putToList(@FormParam("name") final String name,
         @FormParam("age") final int age) {
      addToList(name, age);
   }
   ...
   @DELETE
   @Path("{name}")
   public void deleteFromList(@PathParam("name") final String name) {
